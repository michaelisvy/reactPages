const participantSessionList: Session[] = [
   {
    id: 1,
    date: "20 January 2024 - Saturday morning",
    sessionType: "Climate Fresk",
    host: "Palo IT - Beach Road",
    url: "https://association.climatefresk.org/training_sessions/8fc11326-fa10-4fb2-8670-bb89082bceef/show_public?language=en&tenant_token=36bd2274d3982262c0021755",
  },
   {
    id: 2,
...
const instructorSessionList: Session[] = [
  {
    id: 31,
    date: "17 January 2024 - Wednesday evening",
   ...
   {
    id: 32,
    date: "22 January 2024 - Monday evening",
    sessionType: "Climate Fresk Training",
    host: "Genius Central - Telok Ayer",
    url: "https://association.climatefresk.org/training_sessions/5ac2dffb-5396-43dd-970e-5a1bf172a166/show_public?language=en&tenant_token=36bd2274d3982262c0021755",
  },
   {
    id: 33,
    date: "26 January 2024 - Friday evening",
    sessionType: "Climate Fresk Training",
    host: "Online",
    url: "https://association.climatefresk.org/training_sessions/d084f9be-3e25-4a1e-a33e-eaebb70cb149/show_public?language=en&tenant_token=36bd2274d3982262c0021755",
  },
   {
    id: 34,
    date: "29 January 2024 - Monday evening",
    sessionType: "Climate Fresk Training",
    host: "Online",
    url: "https://association.climatefresk.org/training_sessions/e2797ccc-378b-45f5-857f-f3c90a18c22d/show_public?language=en&tenant_token=36bd2274d3982262c0021755",
  },
  { id: 35,
