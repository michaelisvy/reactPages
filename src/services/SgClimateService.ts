const participantSessionList: Session[] = [
   ...
   },
 {
  ...
  {
   id: 10,
   date: "31 May 2024 - Friday evening",
   sessionType: "Climate Fresk",
   host: "Crane offices - OUE Downtown",
   url: "https://association.climatefresk.org/training_sessions/5bb4eea0-2940-4de0-8e5b-885a93d7ad11/show_public?language=en&tenant_token=36bd2274d3982262c0021755",
   },
  {
   id: 14,
